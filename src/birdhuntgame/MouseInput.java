    ...
    public void playSound(String s) 
{
  ...
  catch (Exception e)
  {
    ...
    public void playSound1(String s) throws LineUnavailableException, IOException 
{
  try
  {AudioInputStream audioInputStream; 
    ...
    if(game.M==game.M.MENU)
    {
        clip.start();
        
        System.out.println("started");
    }
    if(game.M!=game.M.MENU)clip.stop();
   /// if(game.M!=game.M.MENU)
  ...
  catch (Exception e)
  {
    ...
    int a,b;
    public MouseInput(Player p, Pointer ptr, BirdHunt game,Graphics g) 
    {   this.g=g;
        this.p = p;
        this.ptr = ptr;
        this.game = game;
    ...
    public void mouseClicked(java.awt.event.MouseEvent e) 
    {
        ...
        {int x=game.score;
            if (!game.getbird().getBounds(false).intersects(getBounds(a=e.getX(), b=e.getY()))&&
                    !game.getbird().getBounds(true).intersects(getBounds(a=e.getX(), b=e.getY())))
                game.bullets_misused++;
                 this.playSound("/mg3.wav");
            if (game.getbird().getBounds(false).intersects(getBounds(a=e.getX(), b=e.getY()))||
                    game.getbird().getBounds(true).intersects(getBounds(e.getX(), e.getY()))) 
            {  
                game.y = true;
