...
class Game_Setup implements MouseListener {
    ...
    private int h;
    private BirdHunt game=new BirdHunt();
   ...
   public Game_Setup(){}
    ...
    if(game.level==1||game.level==2)
    {
        ...
        {
            ii1 = new ImageIcon("src\\birdl2.gif");
            image1 = ii1.getImage();
            ii2 = new ImageIcon("src\\birdR2.gif");
            image2=ii2.getImage();
            ii3 = new ImageIcon("src/butterfly.gif");
            image3 = ii3.getImage();
        }
    ...
    else  if(game.level>=5)
    {
       ...
       image2=ii2.getImage();
        ...
        g.fillRect(700,650, 550, 21);
        g.setColor(Color.red);
        if(game.M==game.M.GAME1)
        g.drawString("  HighScore::"+HIGHSCORE+"        Created On::"+Date,710,670);
        if(game.M==game.M.GAME2)
        g.drawString("  HighScore::"+HIGHSCORE2+"        Created On::"+Date2,710,670);
       ...
       {
           xr=1000;yr=300;game.health-=20;game.y=false;
       }
       else if (yl<-200)
       {
           xl=0;yl=300;game.health-=20;game.y=false;
       }
       if(game.M==game.M.GAME1)
       {
