...
*/
   ...
   public class BirdHunt extends Canvas implements Runnable 
   {
    private int flag = 0;
    public static final int WIDTH = 1270;
    public static final int HEIGHT =665;
    public static final int SCALE=1;
    public final String TITLE="BIRD HUNT";
    ...
    private synchronized void stop() 
    {
        ...
        try {
            ...
            Logger.getLogger(BirdHunt.class.getName()).log(Level.SEVERE, null, ex);
        }
        System.exit(1);
    }
    /**
...
//tick not doing graphics unlike render it actualls increase the x, y of the birds
  ...
  //the render function handles the graphics and images and things like that
    private void render() throws ClassNotFoundException, SQLException, IOException, LineUnavailableException {
        BufferStrategy bs = this.getBufferStrategy();//getBufferStrategy is from canvas class
        //BufferStrategy handles all the buffering behing the scenes
        //https://docs.oracle.com/javase/7/docs/api/java/awt/image/BufferStrategy.html
        if (bs == null) 
        {
            createBufferStrategy(3);//3 implies that we are having 3 buffers for loading images it is also known as triple buffering increasin this value jus increases the CPU usage and decresing it will lwad to flickering so 3 is optimal as given in oracle's documentation
            return;
        }
        Graphics g;
        g = bs.getDrawGraphics();//creates a graphics context for the buffers or in simple words it simply draws the buffer
        
        /*Anything from line 269 to 369 will be drawn onto the screen*/
        ...
        { 
            ...
            if(t==0)
            {
                ...
                if(curr_time-startTime>29000)
                {Mouse.playSound1("rename.wav");
        ...
        g.dispose();//Disposes of this graphics context and releases any system resources that it is using. A Graphics object cannot be used after disposehas been called.
    ...
    public static Cursor customCursor() //makes the current cursor dissappear
    {
