...
public class Result {
    ...
    Result(BirdHunt game) {
        this.game = game;
    }

    public Rectangle exitsButton = new Rectangle(BirdHunt.WIDTH / 2 + 100, 450, 250, 50);
    public Rectangle restartButton = new Rectangle(BirdHunt.WIDTH / 2 + 100, 510, 250, 50);
